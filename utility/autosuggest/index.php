...
$query = $database->query("select DISTINCT(school_name) as val from school_search_info WHERE (school_name LIKE '".$input."%')  ".$entity." LIMIT 0,5");
    ...
    <a class="closeView" onClick="$('#schoolView').hide();"><i class="fa fa-times fa-2x"></i></a><div class="panel panel-primary">
                        <div class="panel-body">
                               ...
                               <div class="col-sm-4 vschoolProfilePic">
                                          <img src="<?php echo $session->get_school_logo($school['school_code']);?>"  title="<?php echo $school['school_name']; ?>" alt="No Logo" />
                                 </div>
                                 <div class="col-sm-8">
                      ...
                      <ul class="quickFacts" >
                      <?php echo $session->get_qfacts($school['school_code']);?>
                      </ul> </div>
    <?php
